...
public class SyncTrackerWS {
  ...
  private static final int DEF_MAX_CAP_SYNC_HISTORY = 100;
  private static final int DEF_MAX_CORP_SYNC_HISTORY = 100;
  ...
  public Response requestUnfinishedRefSync(
    ...
    try {
      // Retrieve and return unfinished
      List<ESIRefEndpointSyncTracker> results = ESIRefEndpointSyncTracker.getAllUnfinishedTrackers();
      return Response.ok()
                     .entity(results)
                     .build();
    } catch (IOException e) {
